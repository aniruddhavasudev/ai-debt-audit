...
- **Ruby on Rails rule coverage** — third major framework after Next.js/Supabase and Django/Flask. Start with the equivalent footguns: mass assignment, `dangerouslySetInnerHTML`-style raw output, disabled CSRF protection, hardcoded `config/secrets.yml`.
